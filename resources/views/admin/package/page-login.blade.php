			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="<?php echo url('/'); ?>/img/logo-dark.png" alt="ONLINESHOP Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Sistem Pendukung Keputusan Pemilihan Toko Online</h1>
