							...
							<table class="table table-striped">
								<thead>
									<tr>
										...
										<th witdh="50px">Nama Toko</th>
										<th width="50px">Harga Produk</th>
										<th width="50px">Keamanan Transaksi</th>
										<th width="50px">Kualitas Produk</th>
										<th width="50px">Jenis Pengiriman</th>
										<th width="50px">Proses Transaksi</th>
								...
								<tbody>
									...
									<tr>
										...
										<td><input type="text" name="" value="{{ DH->toko_online }}"></td>
										@foreach()
