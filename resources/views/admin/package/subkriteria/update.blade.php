                ...
                <div class="panel col-md-6 col-md-offset-3">
                    ...
                    @foreach($data_sub as $DS)
                        <form action="/admin/sub/formedit/updatesub/{id}" method="post">
                            ...
                            <br>
                            <p>Nilai Perbandingan Kriteria</p>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-list-ol"></i></span>
                                <select class="form-control" name="cbnilaib">
                                    @if($DS->nilaib == 1)
                                    <option value="1" selected>Rendah (Nilai = 1)</option>
                                    <option value="2">Rata-Rata (Nilai = 3)</option>
                                    <option value="3">Tinggi (Nilai = 5)</option>
                                    @elseif($DS->nilaib == 2)
                                    <option value="1">Rendah (Nilai = 1)</option>
                                    <option value="2" selected>Rata-Rata (Nilai = 3)</option>
                                    <option value="3">Tinggi (Nilai = 5)</option>
                                    @elseif($DS->nilaib == 3)
                                    <option value="1">Rendah (Nilai = 1)</option>
                                    <option value="2">Rata-Rata (Nilai = 3)</option>
                                    <option value="3" selected>Tinggi (Nilai = 5)</option>
                                    @else
                                    <option value="1">Rendah (Nilai = 1)</option>
                                    <option value="2">Rata-Rata (Nilai = 3)</option>
                                    <option value="3">Tinggi (Nilai = 5)</option>
