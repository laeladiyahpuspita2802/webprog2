...
Route::group(['middleware' => ['auth', 'cekrole:Admin']], function () {
    ...
    Route::post('/admin/rumah/form/posttoko', [RumahController::class, 'posttoko'])->name('posttoko');
    Route::get('/admin/rumah/formedit/{id}', [RumahController::class, 'tampiledittoko'])->name('edittoko');
    Route::post('/admin/rumah/formedit/updatetoko/{id}', [RumahController::class, 'updatetoko'])->name('updatetoko');
    Route::get('/admin/rumah/hapustoko/{toko_online}', [RumahController::class, 'deltoko'])->name('hapustoko');
...
Route::group(['middleware' => ['auth', 'cekrole:Admin,Customer']], function () {
    ...
    Route::get('/detail/{toko_online}', [HasilController::class, 'tampildetail']);
    ...
    Route::get('/ahp/bobot/kesimpulan/{toko_online}', [HasilController::class, 'tampilkesimpulan']);

    // Cetak PDF
    Route::get('/ahp/bobot/kesimpulan/cetak/{toko_online}', [HasilController::class, 'cetakpdf']);
